...
# Input: n
# Assume n>=0
# Output: up to the nth number in the Fibonacci sequence

0 read r1         #Get n
1 setn r2 0       #Initialize r2
2 setn r3 1       #Initialize r3
3 jeqzn r1 10     #done if r1 is 0
4 write r2        #print out r2
5 add r4 r2 r3    #assign r4 = r2 + r3
6 copy r2 r3      #assign r2 the value of r3
7 copy r3 r4      #assign r3 the value of r4
8 addn r1 -1      #subtract 1 from r1
9 jumpn 3         #jump back to line 3
10 halt           #stop
