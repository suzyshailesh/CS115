...
def findRunBits(s):
    ...
    ans = listOfRunLengths(s)
    ans = sum(ans)/len(ans)
    ans = math.ceil(math.log(ans, 2)) + 1
    ans = min(ans, 7)
    return ans
    # TO DO 
...
def test():
    assert L0 == uncompressA(compressA(L0))
    assert L3 == uncompressA(compressA(L3))
    assert L6 == uncompressA(compressA(L6))
    
    assert compressA(L1) == '00101'
    assert compressA(L4) == '011011011011011'
    assert compressA(L7) == '110100000100000'
    
    assert uncompressA("010001100110010010101"+\
    "010101010101010101010101010101010101010101"+\
    "01010101010101010101") == L2
    assert uncompressA('011100100100100') == L5
    assert uncompressA('110000000011111011111000010') == L8
